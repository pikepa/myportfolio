...
<div class="container mx-auto pb-4">
    <div class="text-center">
        <h1 class="font-bold text-3xl m-2 ">Pages</h1>
    </div>
                ...
                <table class="text-left w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-r border-grey-light">{{ $page->created_date }}</td>
                            <td class="py-4 px-6 border-b border-r  border-grey-light">{{ $page->title }}</td>
                            <td class="flex justify-center py-4  border-b border-r  border-grey-light">
                                <div class="text-grey-lighter text-sm mr-2 hover:font-semibold"><a href="{{ $page->path() }}"><i class="fab fa-readme"> Read</i></a></div>
