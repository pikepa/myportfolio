<div class="h-screen flex overflow-hidden bg-gray-100">
            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                ...
                <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 px-2">
                        ...
                        <div class="mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
                            ...
                            <button wire:click="changePage(1)">Pages</button>
                        </div>

                        <a href="#" class="mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
                            <svg class="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500 transition ease-in-out duration-150" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                            </svg>
                            <button wire:click="changePage(2)">Paragraphs</button>
                        </a>
    ...
    <div class="hidden md:flex md:flex-shrink-0">
        <div class="flex flex-col w-48 border-r border-gray-200 bg-white">
        ...
        <main class="flex-1 relative z-0 overflow-y-auto pt-2 pb-6 focus:outline-none md:py-6" tabindex="0">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div class="">
                    ...
                    @if($pagesmode==1)
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        <h1 class="text-2xl font-semibold text-gray-900">Manage Pages</h1>
                    </div>
                    ...
                    @if($pagesmode==2)
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        <h1 class="text-2xl font-semibold text-gray-900">Paragraphs</h1>
                    </div>
                    @livewire('paragraphs.manage-paras')
                    @endif
                </div>
                <!-- /End replace -->
            </div>
