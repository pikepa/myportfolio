                       <div class="w-1/2 mx-auto mt-4">
                           <div class=" pt-2 mx-auto rounded-b-none text-center rounded text-bold bg-gray-200 text-xl">Add Paragraph</div>
                           <div class="w-full rounded  rounded-t-none shadow-lg border   pb-4">
                               ...
                               <div class="">
                                   ...
                                   <div class="flex justify-around mx-4 block mt-4">
                                       <button wire:click="save()" class="button bg-green-500 ">Submit New Para</button>
                                   </div>
