    ...
    <div class="flex flex-wrap justify-center mt-8 ">
        <div class="w-full max-w-sm">
            ...
            <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                ...
                <div class="text-center font-semibold bg-grey-lightest text-xl text-grey-darkest py-3 px-6 mb-0 shadow-inner">
                    {{ __('Reset Password') }}
                </div>
                ...
                <form class="w-full p-6" method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="flex flex-wrap  justify-center">
                        <button type="submit" class="bg-blue-600 hover:bg-blue-300 text-gray-100 py-2 px-4 rounded focus:outline-none focus:shadow-outline">
